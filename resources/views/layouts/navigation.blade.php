            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ url('/logos/png/Color logo - no background.png') }}" style="height: 35px;" alt="">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('commandes')" :active="request()->routeIs('commandes')">
                        {{ __('Commandes') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('materiels')" :active="request()->routeIs('materiels')">
                        {{ __('Matériels') }}
                    </x-nav-link>
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Clients') }}
                    </x-nav-link>
                    <x-nav-link :href="route('equipes')" :active="request()->routeIs('equipes')">
                        {{ __('Equipes') }}
                    </x-nav-link>
